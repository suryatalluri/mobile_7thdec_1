...
public class QueryExecutionController {
	...
	@ApiOperation(value = "Process request to execute queries")
	@RequestMapping(value = "/queries/test3", method = RequestMethod.GET)
	public Page<Object> executeTest3(
		 Pageable pageable)
	    {
			LOGGER.debug("Executing named query test3");

		Page<Object> result = queryService.executeTest3(pageable);
		LOGGER.debug("got the result of named query {}", result);
		return result;
	}
