...
public class HrdbQueryExecutorServiceImpl implements HrdbQueryExecutorService {
	...
	@Transactional(value = "hrdbTransactionManager")
	@Override
	public Page<Object> executeTest1(Pageable pageable)
	throws QueryParameterMismatchException{
        Map<String, Object> params = new HashMap<String, Object>();
        return queryExecutor.executeNamedQuery("test1", params, pageable);
	}
	@Transactional(value = "hrdbTransactionManager")
	@Override
	public Page<Object> executeTest3(Pageable pageable)
	throws QueryParameterMismatchException{
        Map<String, Object> params = new HashMap<String, Object>();
        return queryExecutor.executeNamedQuery("test3", params, pageable);
	}
